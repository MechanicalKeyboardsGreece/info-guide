---
layout: single
title: "Info Guide - version 0.6.7"
toc: true
...
- **Stem**: Το πάνω μέρος στο οποίο "κάθονται" τα keycaps. Τα Cherry MX και όλα τα κοντινά clones σε αυτά έχουν σαν σχήμα τον κλασσικό `+` σταυρό, ενώ τα Topre έχουνε κυκλικό `O` Stem, αν και κάποιες εκδοχές τους έχουνε υβριδικό `(+)` stem και είναι συμβατές με keycaps για τύπου MX (βλέπε το, πλέον σπάνιο, Coolermaster Novatouch).
...
## <a id="megethosLayout"/>Μέγεθος/Layout
...
## <a name="xrhsimaLinks"/>Χρήσιμα links
